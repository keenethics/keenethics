    ...
    this.steps = [
      {
        ...
        items: [
          'Max, the CEO, and Oleksiy, the CTO, are friends since childhood.',
          'Both started their careers in the IT industry but were not satisfied with the environment.',
          'KeenEthics was set up to do better.',
        ],
        engineers: '7',
        partners: '0',
        projects: '4',
      },
      {
        ...
        items: [
          'The first step was to get our foot in the door of the IT industry.',
          'One of the newest and most popular technologies of that time, Meteor, was our main technical focus.',
          'We organized and attended Meteor meet-ups in Ukraine and Germany.',
      ...
      },
      {
        ...
        items: [
          ...
          'We’ve set up processes to deliver higher quality and be more transparent',
          'We started supporting the educational project %Let Kids Move% and %Hebron Academy%.',
          'A few major sustainability initiatives were launched.',
      ...
      {
        year: '2019',
        title: 'KeenEthics continues developing itself',
        items: [
