...
const whyKeenEthicsList = [
  {
    ...
    other business initiatives. By helping you use resources more
    efficiently, our React Native team helps your business grow.`,
  },
  {
    title: 'Building value.',
    desc: `
    To establish a valuable relationship with users and clients,
    you should communicate with them effectively and often.
    A fast, responsive, and lightweight mobile app with push-notifications
    is the best way to keep customers engaged.
    With React Native, we will help you achieve this goal.`,
  },
  {
    title: 'Launching in a matter of weeks.',
    desc: `
    The greatest advantage of React Native is resource-efficiency.
    With this technology, we will develop two apps over the time needed
    to develop one. Moreover, our partner engagement process is
    optimized greatly to make sure that
    little to no time is spent on repetitive conversations and courtesy calls.`,
  },
  {
    title: 'Bringing tech expertise.',
    desc: `
    Despite all the advantages of it, there are not so many expert
    React Native app development specialists. But we will provide
    you with professionals needed to complete your project.
    Our React Native development company offers not only
    high-quality software solutions but also sound expertise
    in your industry or business field.`,
  },
  {
    title: 'Protecting your data.',
    desc: `
    Your users will never give your app a second chance if they have even
    the slightest doubt about the safety of their information.
    Our expert React Native application development experts
    will make sure
  ...
  <Layout>
    ...
    <div className="content-block">
      ...
      <section>
        ...
        <p>
          There are two target audiences that the mobile app
          owner should aim at, – Android users and iOS
          users, – and neither one can be ignored.
          Developing a separate app for each platform is time-consuming, inconvenient,
          and expensive. React Native solves this problem.
          By offering the opportunity for cross-platform development,
          React Native greatly reduces the amount of resources
          needed for the development of Android and iOS apps without compromising the app quality.
        </p>
        <p>
          React Native is a JavaScript-based cross-platform mobile app development
          framework. 95% of React Native codebase is shared by iOS and Android apps. Moreover,
          some business logic of a web app written in React can be reused
          with the help of React Native application development.
      ...
      <section>
        ...
        <div>
          ...
          <p>
            ParkQX is a mobile application aimed to facilitate the parking
            routine and to spare the unnecessary hustle.
            On the one hand, it helps drivers find, book,
            and pay for a parking spot in a few simple taps. On the other hand,
            it helps parking spot owners profit from their unused parking space. This
            mobile solution has the potential to improve
            the transport and parking situation in any city.
          </p>
          <div>
