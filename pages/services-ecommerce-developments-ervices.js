  ...
  <Layout>
    ...
    <div className="content-block">
      ...
      <section>
        ...
        <p>
          Life is getting busier and faster. People have neither time nor opportunity to spend their 
          time shopping for clothes, groceries, electronics, cosmetics, or furniture. It is much easier 
          ...
          This thousand-billion-dollar industry provides numerous business opportunities for those who 
          choose to enter it.
        </p>
        <p>
        There are 6 types of ecommerce:<br />
        <b>#1 B2B</b> – Business-to-Business<br />
        <b>#2 B2C</b> – Business-to-Consumer<br />
        <b>#3 B2A</b> – Business-to-Administration<br />
        <b>#4 C2B</b> – Consumer-to-Business<br />
        <b>#5 C2C</b> – Consumer-to-Consumer<br />
        <b>#6 P2P</b> – Peer-to-Peer<br />
        </p>
      </section>
      <section>
        ...
        <ul className="challenges-list">
          <li className="challenges-item">
            ...
            <p>
              ...
              make sure that your digital and physical stores are fully aligned.<br />
              <strong>So how can you ensure that transitioning is smooth and cost-efficient?</strong>
            </p>
          </li>
          <li className="challenges-item">
            <h3>
          ...
          <li className="challenges-item">
            ...
            <p>
              ...
              not lose the personal touch with the target market? In other words, <strong>how can 
              you reach your customers when running a digital ecommerce platform?</strong>
            </p>
          </li>
          <li className="challenges-item">
            <ul>
              ...
              <li>
                Inform your loyal customers about the transition of your business into the online sphere.
              </li>
              <li>
          ...
          <li className="challenges-item">
            ...
            <p>
              ...
              may be hard. Existing methods differ in terms of safety features, costs, opportunities, 
              localization, and convenience. <br />
          ...
          <li className="challenges-item">
            <ul>
              <li>
                <a href="https://www.paypal.com/ua/home" target="_blank" rel="noopener noreferrer nofollow">PayPal</a> – available 
                in 200 countries, 8 payment methods, 2.9% fee plus $0.30 per transaction.
              </li>
              <li>
                <a href="https://www.braintreepayments.com/" target="_blank" rel="noopener noreferrer nofollow">Braintree</a> – available 
                in 46 countries, 18 payment methods, 2.9% fee.
              </li>
              <li>
                <a href="https://stripe.com/" target="_blank" rel="noopener noreferrer nofollow">Stripe</a> – available 
                in 26 countries, 14 payment methods, 2.9% fee plus $0.30 per incoming transaction.
              </li>
              <li>
                and <a href="https://www.entrepreneur.com/article/286006" target="_blank" rel="noopener noreferrer nofollow">many others</a>...
              </li>
            </ul>
          </li>
          <li className="challenges-item">
            <b>Data safety</b>
            <p>
              Information leaks, cybercrimes, and identity thefts are among the most dangerous threats for Internet users and business owners. 
              When moving your business online, you definitely want to make sure that it is not going to fall victim to cybercriminals. <br />
          ...
          <li className="challenges-item">
            ...
            <p>
              ...
              equals losing the competition. <br />
            <strong>
      ...
      <section>
        <div>
          <h3>ParkQX</h3>
          <p>
            The goal of ParkQX is to make parking routine easy, hassle-free, climate neutral, and convenient. 
            It helps drivers (Renters) find, book, and pay for a parking spot with their credit card in a few simple taps. 
      ...
      <section>
        ...
        <p>
          We help companies requesting ecommerce website development services grow. We develop customized 
          solutions to help them retain their customers. Besides, we offer SEO-optimization services for their 
          websites.
        </p>

        <h3 className="red-italic-title"><span style={{ fontSize: '28px', marginRight: '.5em' }}>2</span> Building value</h3>
        <p>
          We believe in business ethics and transparency. As an ecommerce development company, we help our partners fully comply 
          with ethical guidelines and data security regulations to ensure the best experience for their customers.
        </p>

        <h3 className="red-italic-title"><span style={{ fontSize: '28px', marginRight: '.5em' }}>3</span> Launching in a matter of weeks</h3>
        <p>
          We are willing to start working on your project as fast as possible. Thus, we promptly provide you with a team of full-stack 
          software developers, QA specialists, and UI/UX designers. Led by a dedicated PM, they will offer you the best ecommerce 
