...
const PrivacyPolicy = () => (
  <Layout>
    ...
    <div className="content-block">
      ...
      <section>
        <h3>Log Data</h3>
        <p>We want to inform you that whenever you visit our Services, we collect information that your browser sends to us that is called Log Data. This Log Data may include information such as your computer’s Internet Protocol ("IP") address, browser version, the pages of our Services that you visit, the time and date of your visit, the time spent on those pages, and other statistics.</p>
      </section>
      <section>
        <h3>Cookies</h3>
        ...
        <p>Our website uses "cookies" to collect information and to improve our Services. You have the option to either accept or refuse these cookies and know when a cookie is being sent to your computer. If you choose to refuse our cookies, you may not be able to use some portions of our Services.</p>
      </section>
      <section>
      ...
      <section>
        <h3>Contact Us</h3>
        <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at business@keenethics.com.</p>
      </section>
    </div>
  </Layout>
);
