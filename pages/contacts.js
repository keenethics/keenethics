...
export default class Contacts extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isPending: false,
      status: '',
      isHelloForm: false, // TODO: set true
    };
  ...
  toggleForm = () => this.setState({ isHelloForm: !this.state.isHelloForm })

  render() {
    const { url } = this.props;
    const { isHelloForm } = this.state;
            ...
            <div className={classnames('contacts-content', { 'estimate-contact': !isHelloForm })} itemScope itemType="http://schema.org/Organization">
              ...
              <div className="contacts-content-left">
                <div className="contacts-buttons">
                  <button className={classnames('contacts-button-hello', { disabled: !isHelloForm })} onClick={this.toggleForm}>Say hello</button>
                  <button className={classnames('contacts-button-estimate', { disabled: isHelloForm })} onClick={this.toggleForm}>Estimate your project</button>
                </div>
              ...
              <div className="contacts-form-container">
                ...
                {isHelloForm ? <ContactForm updateState={this.updateState} /> : <EstimateForm />}
              </div>
            </div>
          </div>
          <Background />
