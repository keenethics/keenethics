...
const ServicesWebDevelopmentNode = () => {
  ...
  const nodeJsWorks = works.filter(({ title }) => ['OneRemission', 'Pree', 'SelfLeaders'].includes(title));
    ...
    <Layout>
      ...
      <div className="content-block">
        ...
        <section>
          ...
          <p>Such popular websites as <a href="//www.paypal.com/ua/home">PayPal</a>, <a href="//www.wsj.com/">The Wall Street Journal</a>, <a href="//www.ibm.com/ua-uk/">IBM</a>, <a href="//www.linkedin.com/" target="_blank" rel="noopener noreferrer nofollow">LinkedIn</a>, <a href="//www.microsoft.com/uk-ua/">Microsoft</a>, <a href="//www.netflix.com/ua/" target="_blank" rel="noopener noreferrer nofollow">Netflix</a>, <a href="//www.walmart.com/">Walmart</a>, <a href="//www.yahoo.com/" target="_blank" rel="noopener noreferrer nofollow">Yahoo!</a> are powered by Node.js.</p>
        </section>
              ...
              whatDoWeOfferIcons.map(({ iconTitle, description }, key) => (
                <li key={key} className="web-development-node-item">
                  <figure>
                    ...
                    <figcaption className="web-development-node-figcaption">{description}</figcaption>
                  </figure>
                </li>
              ))
            }
        ...
        <section>
          ...
          <p>We offer a <b>reasonable pricing policy</b> and the opportunity to choose a paying model you prefer, should it be a fixed price or a “<Link href="/blog/outsourcing-vs-outstaffing"><a>Time & Materials</a></Link>” approach. We perfectly follow <Link href="/blog/1543388400000-your-data-is-safe-in-ukraine"><a>data security</a></Link> regulations and the requirements of the NDA you choose to sign.</p>
          ...
          <h3 className="red-italic-title">High-quality solutions.</h3>
