        ...
        <div className="project-content">
          ...
          <div className="project-content-more">
            <section>
              ...
              <p>The hospital management system we have developed is <b>a platform for online searching and scheduling medical checks or appointments with a doctor</b>. It also features a messenger to chat with a healthcare provider. Through this hospital management software, a user can get in touch with a medical specialist in a few moments and get answers to all the pressing questions 24 hours a day, seven days a week. Also, the web platform features a messenger – a hotline via which users can ask questions or request consultations.</p>
