...
const PromoPage = () => {
  const aboutUsList = [
    ...
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="40" height="46" viewBox="0 0 40 46">
          <defs>
    ...
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="51" height="40" viewBox="0 0 51 40">
          <defs>
